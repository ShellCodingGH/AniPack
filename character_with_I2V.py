    ...
    for x in range(num_images):
        ...
        while not res_image.getbbox() and i < 10:
            if isinstance(pipe, StableDiffusionReferencePipeline):
                ...
                res_image = pipe_img2img(height=height, width=width, image=input_img, strength=0.6, prompt_embeds=prompt_embeds, negative_prompt_embeds=negative_prompt_embeds, num_inference_steps=40).images[0]
